...
public class Board extends JPanel {
	...
	private void initializeSquares() {
		...
		Square square01 = new Square(106,6,100,100,"Campo Grande",180,100,60,0.68);
		this.add(square01);
		...
		Square square03 = new Square(306,6,100,100,"R. Faria Guimarães",180,100,60,0.68);
		this.add(square03);
		allSquares.add(square03);
		
		Square square04 = new Square(406,6,100,100,"Av. Fernão Magalhães",180,120,70,0.7);
		this.add(square04);
		allSquares.add(square04);

		Square square05 = new Square(506,6,100,100,"Al. Linhas de Torres",180,140,90,0.73);
		this.add(square05);
		...
		Square square07 = new Square(706,6,100,100,"Av. Nações Unidas",180,140,90,0.73);
		this.add(square07);
		allSquares.add(square07);

		Square square08 = new Square(806,6,100,100,"Av. 24 de Julho",180,160,100,0.75);
		this.add(square08);
		...
		Square square10 = new Square(906,106,100,100,"Av. Central",-135,180,120,0.78);
		this.add(square10);
		...
		Square square12 = new Square(906,306,100,100,"R. Ferreira Borges",-90,180,120,0.78);
		this.add(square12);
		allSquares.add(square12);
		
		Square square13 = new Square(906,406,100,100,"Av. de Roma",-90,200,130,0.80);
		this.add(square13);
		allSquares.add(square13);

		Square square14 = new Square(906,506,100,100,"Av. da Boavista",-90,220,150,0.83);
		this.add(square14);
		...
		Square square16 = new Square(906,706,100,100,"Av. da República",-135,220,150,0.83);
		this.add(square16);
		allSquares.add(square16);
		unbuyableSquares.add(square16);

		Square square17 = new Square(906,806,100,100,"R. Mouzinho da Silveira",-135,240,160,0.85);
		this.add(square17);
		...
		Square square19 = new Square(806,906,100,100,"R. de Santa Catarina",0,260,180,0.88);
		this.add(square19);
		...
		Square square21 = new Square(606,906,100,100,"Av. Infante Santo",0,260,180,0.88);
		this.add(square21);
		allSquares.add(square21);
		
		Square square22 = new Square(506,906,100,100,"R. Júlio Diniz",45,280,190,0.90);
		this.add(square22);
		allSquares.add(square22);

		Square square23 = new Square(406,906,100,100,"Praça da República",0,300,210,0.93);
		this.add(square23);
		allSquares.add(square23);

		Square square24 = new Square(306,906,100,100,"Av. Fontes de Melo",0,300,210,0.93);
		this.add(square24);
		...
		Square square26 = new Square(106,906,100,100, "Rot. da Boavista",0,320,220,0.95);
		this.add(square26);
		...
		Square square28 = new Square(6,806,100,100,	"Av. da Liberdade",90,340,240,0.78);
		this.add(square28);
		allSquares.add(square28);
		
		Square square29 = new Square(6,706,100,100,"R. dos Clérigos",90,340,240,0.78);
		this.add(square29);
		...
		Square square31 = new Square(6,506,100,100, "Av. Parque das Nações",90,360,250,0.80);
		this.add(square31);
		allSquares.add(square31);

		Square square32 = new Square(6,406,100,100,"R. das Amoreiras",90,380,270,0.83);
		this.add(square32);
		allSquares.add(square32);

		Square square33 = new Square(6,306,100,100,"R. Augusta",90,380,270,0.83);
		this.add(square33);
		...
		Square square35 = new Square(6,106,100,100,"Rossio",90,400,280,0.85);
		this.add(square35);
